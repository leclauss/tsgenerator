...
namespace tsg {
  ...
  void generateBoxMotif(rseq &subsequence_out, const double warp_in, const
      double scale_in, const int length_in, const double height_in) {
  ...
  void generateTriangleMotif(rseq &subsequence_out, const double warp_in,
  ...
  void generateSemicircleMotif(rseq &subsequence_out, const double warp_in,
    ...
    if (realLength > 2) {
      ...
      for (; itr > 0; itr -= 2)
        subsequence_out.push_back(scaleFactor * sqrt((diameter / 2.0)
              * (diameter / 2.0) - (itr / 2.0) * (itr / 2.0)));
  ...
  void generateSineMotif(rseq &subsequence_out, const double warp_in, const
      double scale_in, const int length_in, const double height_in) {
    ...
    if (realLength > 2) {
      ...
      for (int itr = 0; itr < realLength - 1; itr++)
        if (realLength % 2 == 1 && itr == middle)
          ...
          subsequence_out.push_back(scale * height * sin((2 * M_PI)
                / (realLength - 1.0) * itr));
    }
  ...
  void generateCosineMotif(rseq &subsequence_out, const double warp_in, const
      double scale_in, const int length_in, const double height_in) {
